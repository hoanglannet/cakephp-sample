<div class="groups index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('default_controller');?></th>
			<th><?php echo $this->Paginator->sort('default_action');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $group['Group']['default_controller']; ?>&nbsp;</td>
		<td><?php echo $group['Group']['default_action']; ?>&nbsp;</td>
		<td class="actions">
